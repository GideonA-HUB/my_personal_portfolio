...
class Project(models.Model):
    ...
    image = models.ImageField(upload_to='projects/', blank=True, null=True, help_text="Upload project image")
...
class PersonalInfo(models.Model):
    ...
    profile_image = models.ImageField(upload_to='profile/', blank=True, null=True, help_text="Upload profile image")
    email = models.EmailField()
...
class Testimonial(models.Model):
    ...
    photo = models.ImageField(upload_to='testimonials/', blank=True, null=True, help_text="Upload testimonial photo")
    order = models.IntegerField(default=0, help_text="Order in which to display (lower numbers first)")
